      ...
      >
        <v-card tile>
          <v-toolbar card dark color="primary">
            <v-btn icon dark @click.native="dialog2 = !dialog2;$eventBus.$emit('hide_settings', {})">
              <v-icon>close</v-icon>
            </v-btn>
            <v-toolbar-title>Settings</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
              <v-btn dark flat @click.native="dialog2 = !dialog2">Save</v-btn>
            </v-toolbar-items>
            <v-menu bottom right offset-y>
              ...
              <v-list>
                <v-list-tile v-for="(item, i) in items" :key="i" to="">
